<%@ Page Title="" Language="C#" MasterPageFile="~/PracticaMaD.Master" AutoEventWireup="true" CodeBehind="AddBankCard.aspx.cs" Inherits="Es.Udc.DotNet.PracticaMaD.Web.Pages.Shopping.AddBankCard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
    <div align="center">
        ...
        <br />
        <br />
        <asp:HyperLink ID="lnkGoBackToBuyOrder" runat="server"
                NavigateUrl="~/Pages/Shopping/BuyOrder.aspx"
                Text="<%$ Resources:, lnkGoBackToBuyOrderRes %>" ForeColor="#0033CC" />
        <br />
        <br />
    </div>
</asp:Content>

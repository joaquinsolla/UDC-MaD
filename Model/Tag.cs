...
namespace Es.Udc.DotNet.PracticaMaD.Model
{
    ...
    public partial class Tag
    {
        ...
        public long tagShows { get; set; }
    
        
        /// <summary>
        /// Relationship Name (Foreign Key in ER-Model): Comment_Tag
        /// </summary>
    	...
    	public override int GetHashCode()
    	{
    	    unchecked
    	    {
    			...
    			hash = hash * multiplier + tagShows.GetHashCode();
    	...
    	public override String ToString()
    	{
           ...
           strTag.Append(" tagShows = " + tagShows + " | " );       
            strTag.Append("] ");    
